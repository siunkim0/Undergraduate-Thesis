...
era = "2016UL_OpenData"
histkey_before = "Central/TrigEff_LooseProbe_Overall_Pt_BeforeTrig"
histkey_after = "Central/TrigEff_LooseProbe_Overall_Pt_AfterTrig"
Data = "SingleMuon_OpenData_H"
MCs = "ZToMuMu_OpenData"

# set config
config = {
    "xTitle": "Probe Muon p_{T} [GeV]",
...
c.Update()
c.SaveAs("/Trigger_pt_SF.pdf")

print("=" * 50)
print("Done! Created:")
print("  - Trigger_pt_SF.pdf")
print("=" * 50)
